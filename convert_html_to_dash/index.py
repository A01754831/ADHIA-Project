html.Div(
    ...
    children=[
        html.Div(
            ...
            style={"background-image": "url(/ruta/a/tu/imagen.jpg)"},
        ...
        html.Header(
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        html.H2(
                            className="mb-4 font- text-4xl md:text-6xl type",
                            ...
                            children=[
                                html.Div(
                                    ...
                                    children=[
                                        html.Img(
                                            ...
                                            src="/images/restaurant-icon.jpg",
                                ...
                                html.Div(
                                    ...
                                    children=[
                                        html.Img(
                                            className="shadow-lg rounded-lg",
                                            src="/images/prediction-icon.jpg",
